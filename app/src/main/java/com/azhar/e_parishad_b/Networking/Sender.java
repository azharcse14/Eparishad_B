...
public class Sender extends AsyncTask<Void,Void,String> {
    ...
    Context c;
    String urlAddress;
    String holdingnumber = "12345";
    String khananumber = "345678";
    ProgressDialog pd;
    ...
    */
    ...
    public Sender(Context c, String urlAddress, String holdingnumber, String khananumber) {
        this.c = c;
   ...
   */
    ...
    private String send()
    {
        ...
        try
        {
            ...
            bw.write(new DataPackager(holdingnumber, khananumber).packData());
