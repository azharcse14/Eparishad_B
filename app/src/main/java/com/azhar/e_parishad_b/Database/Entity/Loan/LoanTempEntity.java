...
public class LoanTempEntity {
    ...
    public LoanTempEntity(int id, String loanName, String isfinancialsupported, String financialsupportfrom, String loanInstitute, String loanAmount, String loanPeriod, String year, String month, String day, String kinnumber) {
        this.id = id;
    ...
    public LoanTempEntity(String loanNamer, String isfinancialsupportedr, String financialsupportfromr, String loanInstituter, String loanAmountr,  String yearr, String monthr, String dayr, String loanPeriodr, String kinnumberr) {
