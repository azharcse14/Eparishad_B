...
@Database(entities = {FDEntity.class, MNEntity.class, MemberTempEntity.class, LoanEntity.class, LoanTempEntity.class, FaEntity.class}, version = 1, exportSchema = false)
